...
Every item in review's Section 4, asserted behaviourally. These exist
because earlier MCP tests validated schema shape rather than
...
_SENTINEL_REFERENCES = {
    "test_release_and_mcp.py", "test_runtime_limits.py",
...
# ---- result status and exit semantics ----------------------------------- #
